...
,p_required_patch=>wwv_flow_api.id(68392720747935952)
,p_dialog_chained=>'N'
,p_protection_level=>'C'
,p_last_updated_by=>'PRIDESYS'
,p_last_upd_yyyymmddhh24miss=>'20220301142052'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(68510071566941228)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(68510462981941232)
,p_name=>'P10051_PAGE_ID'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_api.id(68510071566941228)
